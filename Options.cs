...
{
    [Option('d', "PrintDiff", HelpText="Prints 5 different lines. (This is just to analyze pattern in differences)", Required = false)]
    public bool PrintTopDiffs { get; set; } = false;
}